...
wd$Innotop <- paste0(wd$Hardware[1], "P902780_FermentPAT_ISB_Innotop/")
wd$Innotop$AP2 <- paste0(wd$Hardware[1], "P902780_FermentPAT_ISB_Innotop/Arbeitspakete/AP-02_Entscheidung_Entgasung_Filtration_Zentrifuge/")
